...
- nvidia
thread_kind: meta
blurb: The combined ~$725B+ 2026 capex plan across Google/Meta/Amazon/ Microsoft and
  whether AI revenue is catching up to it — the question every one of the four sub-threads
  below is answering from one hyperscaler's angle. Track the aggregate trend (all
  four raising guidance in the same direction is a different story than a mixed picture),
  credit-market reaction to debt-financed capex, and any hyperscaler actually pulling
  back.
---
