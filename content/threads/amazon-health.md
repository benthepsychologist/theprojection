...
blurb: Amazon's push is primary-care + pharmacy + a Bedrock 'Health AI' agent layer;
  MH is adjacent, not headline. The MH-native move is UPSTREAM in AWS (HealthScribe's
...
## 2026-03 — Health AI goes broad

- **Amazon's agentic "Health AI" launched publicly** on Amazon.com + the app
  (beyond the One Medical pilot) — Bedrock multi-agent, reads records via
...
- **One Medical "Health Insights"** (50+ biomarkers, wellness scores incl.
  "stress management" via Lifeforce) + Pharmacy same-day delivery expanding
...
- **AWS HealthScribe added a GIRPP behavioral-health note template**;
